...
class Interaction:
    ...
    def interactive_2(self):
        print(f"\nСтраница {1} из {10}\nЧтобы перейти к следующей, нажми Enter")
        print(f"\nВы можете сравнить вакансии между собой. Для этого введите 123, затем номера вакансий (пример)")
        print(f"Вы можете удалить вакансию, если она вас не интересует. Для этого введите ее номер")
